/**
 * SPELLING BEE — Lista de palabras
 *
 * Para cada palabra:
 *   word     → la palabra en MAYÚSCULAS
 *   emoji    → emoji de respaldo (se muestra si no hay imageUrl)
 *   imageUrl → URL de imagen real (tiene prioridad sobre emoji)
 *
 * Se dividen automáticamente en bloques de BLOCK_SIZE.
 */
